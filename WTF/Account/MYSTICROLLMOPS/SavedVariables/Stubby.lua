...
StubbyConfig = {
	...
	["boots"] = {
		["enchantrix"] = {
			...
			["triggers"] = "		if Stubby.GetConfig(\"Enchantrix\", \"LoadType\") == \"always\" then\n			LoadAddOn(\"Enchantrix\")\n		else\n			Stubby.Print(\"Enchantrix n'est pas chargé. Tapez /enchantrix pour plus d'informations.\")\n		end\n	",
		},
		["informant"] = {
